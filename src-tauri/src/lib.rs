...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_medical_orders,
            commands::create_medical_order,
            commands::update_medical_order,
            commands::delete_medical_order,
            commands::ai_chat,
            ...
            commands::create_consultation,
            commands::get_consultations,
            commands::update_consultation_status,
            commands::add_consultation_opinion,
            commands::log_audit,
            commands::get_audit_logs,
            commands::export_backup,
            commands::import_backup,
            commands::get_all_patient_details,
            commands::get_patient_detail,
            commands::create_patient_detail,
            commands::get_patient_trends,
            commands::get_patient_drg,
